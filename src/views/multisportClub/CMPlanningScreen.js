...
function CMPlanningScreen({ navigation, route }) {
  ...
  if (isLoadingUserData && !resolvedCmId) {
    return (
      <MultisportStateView
        description={t('multisport.planning.loadingUser', 'Nous préparons le planning de ta structure multisport.')}
        isLoading
  ...
  if (userDataError && !resolvedCmId) {
    return (
      <MultisportStateView
        ...
        description={t('multisport.planning.userError', "Impossible de retrouver ta structure multisport pour le moment.")}
  ...
  if (isLoadingCmData && !cmData) {
    return (
      <MultisportStateView
        description={t('multisport.planning.loading', 'Nous chargeons les informations de ta structure multisport.')}
        isLoading
