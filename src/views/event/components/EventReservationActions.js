 ...
 * @param root0
 * @param root0.event
 * @param root0.hasAlreadyJoined
 * @param root0.mutations
 * @param root0.userData
 */
function EventReservationActions({
  event,
  hasAlreadyJoined,
  mutations,
  userData,
  ...
  const {
    bookFullMutation, joinReservationMutation, openForPlayersMutation, sosAlertMutation,
  } = mutations;
      ...
      <View style={[Spaces.gap[8]]}>
        ...
        <View style={[Alignments.row, Spaces.gap[8]]}>
          ...
          <Button
            ...
            style={{ backgroundColor: '#FF6B35', flex: 1 }}
