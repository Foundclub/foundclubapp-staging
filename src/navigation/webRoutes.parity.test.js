...
// Source de verite UNIQUE des exemptions, partagee avec le filet web
// (web/scripts/check-web-route-coverage.mjs la lit aussi) : une exemption se
// decide la-bas, jamais ici.
const { MOBILE_ONLY_SCREENS, UNREGISTERED_WEB_PATTERNS } = require('./webRouteExemptions');
