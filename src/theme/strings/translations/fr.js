export default {
  ...
  training: {
    ...
    day: {
      ...
      progress: '{{done}} test sur {{total}} fait',
      progress_plural: '{{done}} tests sur {{total}} faits',
    ...
    plan: {
      ...
      progress: '{{done}} journée sur {{total}}',
      progress_plural: '{{done}} journées sur {{total}}',
      title: 'Mon entraînement',
    },
    program: {
      contains: 'Ce que contient le programme',
      days: '{{count}} journée',
      days_plural: '{{count}} journées',
    ...
    sync: {
      ...
      offline: '{{count}} mesure en attente d\'envoi',
      offline_plural: '{{count}} mesures en attente d\'envoi',
