export default {
  ...
  superAdminContentManager: {
    ...
    alerts: {
      ...
      emptySelectionMessage: 'Selectionnez au moins une entree.',
      ...
      uploadNoFile: 'Aucun fichier n a ete recu par le serveur.',
      validationTitle: 'Validation',
    },
    bulkModal: {
      description: 'entree(s) seront traitees. Une raison d audit est obligatoire.',
      reasonPlaceholder: 'Raison obligatoire (minimum 3 caracteres)',
      titleSuffix: 'les entrees',
    },
    common: {
    ...
    detail: {
      ...
      rawJsonCollapsed: 'Vue avancee repliee pour garder l ecran lisible.',
      sections: {
        audit: 'Audit recent',
    ...
    empty: {
      explorerDescription: 'Ajustez la recherche ou verifiez les permissions Super Admin.',
      explorerTitle: 'Aucun content-type trouve',
      listDescription: 'Aucune donnee ne correspond aux filtres actifs.',
      listTitle: 'Aucune entree',
    },
    explorer: {
    ...
    feedback: {
      bulkApplied: 'action(s) appliquee(s)',
      clipboardUnavailable: 'Copie indisponible sur cette build',
    ...
    form: {
      ...
      noMediaSelected: 'Aucun media selectionne.',
      none: 'Aucun',
      ...
      sections: {
        ...
        relations: 'Relations',
        relationsHint: 'Associez des entrees liees.',
        scalars: 'Scalaires',
        scalarsHint: 'Texte, nombres et dates.',
      },
      titleCreate: 'Creer une entree',
      titleEdit: 'Modifier une entree',
      type: 'Type',
    ...
    list: {
      page: 'Page',
      searchPlaceholder: 'Rechercher une entree',
      selectedEntries: 'entree(s) selectionnee(s)',
      total: 'Total',
      updatedPrefix: 'Maj:',
    },
    media: {
