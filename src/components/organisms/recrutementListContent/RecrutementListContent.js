...
function RecrutementListContent({ initialTab, timestamp }) {
            ...
            renderItem={({ item }) => {
              ...
              return (
                <View style={[Spaces.gap[8]]}>
                  ...
                  <RecruitmentAdCard ad={item} isOwner onPress={(/** @type {RecruitmentAdItem} */ ad) => handleAdCardPress(ad, true)} />
                </View>
              );
            }}
          />
  ...
  const renderPlayerContent = () => (
    <>
      <View style={[Spaces.marginBottom[16], { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }]}>
        ...
        <FlatList
          ...
          ListEmptyComponent={(
            <View style={[Spaces.padding[24], { alignItems: 'center' }]}>
              ...
              <Text style={[Fonts.p2, Fonts.neutral600, { marginTop: 8, textAlign: 'center' }]}>
                {filterByLevel
